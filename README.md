...
<ol>
    ...
    <li>explode()------breaks/convert a string into an array-------$str = "Hello world. It's a beautiful day.";--------print_r (explode(" ",$str));---------meaning: string er jei khane space pabe seikhane ekti array item dore array ti banabe-------output: Array ( [0] => Hello [1] => world. [2] => It's [3] => a [4] => beautiful [5] => day. )</li>
</ol>
